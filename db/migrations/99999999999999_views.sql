-- migrate:up
drop view if exists annual_email_report, annual_tax_report, annual_tax_report_const, annual_tax_report_current_payments, annual_tax_report_data, annual_tax_report_gavebrev_all_payments, annual_tax_report_gavebrev_checkins, annual_tax_report_gavebrev_expected_totals, annual_tax_report_gavebrev_results, annual_tax_report_gavebrev_since, annual_tax_report_gaveskema, charge, charges_to_charge, charge_with_gateway_info, donation, donations_to_create_charges, donations_to_email, donation_with_contact_info, donation_with_sensitive_info, donor, donor_with_contact_info, donor_with_sensitive_info, failed_recurring_donations, fundraiser, fundraiser_activity_checkin, gavebrev, gavebrev_checkin, gavebrev_checkins_to_create, ignored_renewals, kpi, old_ids_map, pending_distribution, skat, skat_gaveskema, time_distribution, transfer, transfer_overview, transfer_pending, transferred_distribution cascade;
...
create rule donor_with_contact_info_soft_delete as on delete to donor_with_contact_info
    do instead
    update
        _donor set
        deleted_at = now()
...
grant insert, update, delete on donor_with_contact_info to writer;
...
create rule donor_with_sensitive_info_soft_delete as on delete to donor_with_sensitive_info
    do instead
    update
        _donor set
        deleted_at = now()
...
grant insert, update, delete on donor_with_sensitive_info to writer;
...
create rule donation_with_contact_info_soft_delete as on delete to donation_with_contact_info
    do instead
    update
        _donation set
        deleted_at = now()
...
grant insert, update, delete on donation_with_contact_info to writer;
...
create rule donation_with_sensitive_info_soft_delete as on delete to donation_with_sensitive_info
    do instead
    update
        _donation set
        deleted_at = now()
...
grant insert, update, delete on donation_with_sensitive_info to writer;
...
create rule charge_with_gateway_info_soft_delete as on delete to charge_with_gateway_info
    do instead
    update
        _charge set
        deleted_at = now()
...
grant insert, update, delete on charge_with_gateway_info to writer;
...
create rule transfer_soft_delete as on delete to transfer
    do instead
    update
        _transfer set
        deleted_at = now()
...
grant update on donations_to_email to writer;
...
grant select on annual_tax_report_gavebrev_results to reader_sensitive;
...
grant select on annual_tax_report_gaveskema to reader;
...
grant select on ignored_renewals to reader_contact;
