...
export function membershipReceiptEn(
  donation: DonationToEmail,
  bank?: BankTransferInfo
) {
  const { id, amount } = donation;

  const text = `<li>Your "membership number" is your TIN (Tax Identification Number).</li>
<li>The membership fee of ${amount} DKK is charged now and thereafter yearly (automatically).</li>
<li>Email to <a href="mailto:donation@giveffektivt.dk">donation@giveffektivt.dk</a>, if you want to cancel the membership.</li>
<li>Donation-ID: ${id}.</li>`;
  return membershipTemplateEn(text);
}

export function membershipTemplateEn(text: string) {
  return `<!DOCTYPE html>
<html>
	<head>
		<link href="https://fonts.googleapis.com/css2?family=Poppins&display=swap" rel="stylesheet">
	...
	<body>
		<div class="row">
			<div class="header_container">
				...
				<div style="float: left;">
					...
					<div class="header_text">
						Your membership makes Giv Effektivt stronger.
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<h1>What is a membership?</h1>
			<p>
				The membership is a <a href="https://giveffektivt.dk/fradrag/" target="_blank">legal formality for tax deductability</a> so you won't hear much from us.
			</p>
			<p>
				<a href="http://eepurl.com/hZhf_D" target="_blank">Subscribe to our newsletter</a> (in Danish), where we send 4-6 emails every year with latest news about Giv Effektivt and how you can help with effective altruism in Denmark.
			</p>
		</div>
		...
		<div class="row">
			<h1>Contact us</h1>
			<p>
			    If you have questions, comments, or improvement suggestions, you are always welcome to contact us via <a href="mailto:donation@giveffektivt.dk">donation@giveffektivt.dk</a> or phone +45 40 33 10 97.
				<br /><br />
			</p>
		</div>
		...
		<div class="row">
			<div class="share_container">
				<h1>Inspire others to give effectively</h1>
				<p>
				    You can increase the effect of your donation by inspiring others to become a member and to give effectively. Mention an effective charity to your family or a good friend, who shares your desire to help others in need.
					<br /><br />
					For example, you can share the link to <a href="https://giveffektivt.dk">giveffektivt.dk</a>:
				</p>
				<div id="share-buttons">
					<p>
						<!-- Twitter -->
						<a href="https://twitter.com/intent/tweet?text=I%20have%20just%20donated%20to%20the%20world's%20most%20effective%20organizations%20via%20%40GivEffektivt.%20The%20effect%20is%20100x%20bigger%20than%20typical%20organizations.%20Read%20more%20at%20https://GivEffektivt.dk." target="_blank">
							<img alt="Twitter" src='cid:twitterLogo' ></img>
						</a>
						...
						&nbsp;&nbsp;
						<!-- LinkedIn -->
						<a href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A//giveffektivt.dk&title=Giv%20Effektivt&summary=Give%20to%20the%20world's%20most%20effective%20charities%20and%20make%20a%20bigger%20difference.&source=" target="_blank">
							<img alt="LinkedIn" src='cid:linkedinLogo' ></img>
						</a>
					</p>
				</div>
